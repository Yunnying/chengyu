...
var _n17,
    r =
        ...
        function (t, e) {
            ...
            _n17(t, e), (t.prototype = null === e ? Object.create(e) : ((o.prototype = e.prototype), new o()));
        }),
    i =
    ...
    s =
        ...
        (function (t) {
            ...
            return (
                ...
                (e.saveData = function (t, e, o) {
                    (t = null != (t = cc.sys.localStorage.getItem("" + t)) && null != t && "" != t ? JSON.parse(t) : 0),
                        o && cc.sys.localStorage.setItem("" + t, JSON.stringify(o));
                }),
                i([a], e)
            );
        })(cc.Component));
