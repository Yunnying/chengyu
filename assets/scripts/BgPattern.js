...
var c = t("Loading"),
    ...
    u = (function (t) {
        function e() {
            ...
            return (e.priceNum = null), (e.employ = null), e;
        }
        return (
            r(e, t),
            ...
            (e.prototype.onBttn = function () {
                ...
                var e = this.node.parent.parent.parent.getComponent(a.default),
                    o = this.node.getChildByName("name").getComponent(cc.Label).string,
                ...
                1 == this.node.getChildByName("acquire").active
                    ? ((this.node.getChildByName("acquire").active = !1),
                      ...
                      e.bgUsed(o),
                      a.default.bgArr.forEach(function (e) {
                          e.getChildByName("employ").active = e == t.node;
                      }))
                    : 1 == this.priceNum.parent.active && e.bgInit(o, n);
            }),
